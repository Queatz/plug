...
var plugControllers = angular.module('plugControllers', ['kioskServices', 'kioskAnimations']);

plugControllers.controller('HomeController', ['$scope', '$location', function ($scope, $location) {
...
plugControllers.controller('TermsController', ['$scope', '$location', '$timeout', function ($scope, $location, $timeout) {
...
plugControllers.controller('AuthController', ['$scope', '$timeout', '$location', 'activity', 'InputServices', AuthController]);
...
function AuthController($scope, $timeout, $location, activity, InputServices) {
    ...
    inputPromise.then(function (cred) {
        $scope.cred = cred;
        $scope.$apply();
        console.log(cred);
    })['catch'](function () {
...
plugControllers.controller('DropoffController', ['$scope', '$timeout', '$location', '$interval', '$rootScope', function ($scope, $timeout, $location, $interval, $rootScope) {
...
plugControllers.controller('PickupController', ['$scope', '$timeout', '$location', '$interval', '$rootScope', 'Lock', 'Kiosk', 'AuthService', function ($scope, $timeout, $location, $interval, $rootScope, Lock, Kiosk, AuthService) {
